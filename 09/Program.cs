...
namespace _09
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //if (sum == 0)
            //{
            //    Console.WriteLine("The sum of all items in the array equals 0");
            //}
            //if (sum < 0)
            //{
            ...
            //                    if (sum == 0)
            //                    {
            //                        Console.WriteLine("The sum of some subsets in array equal 0");
            //                        flag = false;
            //                        break;
            //                    }
            //                    else continue;
            ...
            //    if (flag)
            //    {
            //        Console.WriteLine("There are no sum of subsets in the array that equal 0");
            //    }
            //}
            //Console.ReadKey();

            int[] inputArray = { 3, -2, 1, 1, 8 };
